...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  # Specifies the Resource Group where the Kubernetes Cluster NODE should exist (MUST BE EMPTY).
...
# Workflow nodepool used by AKS apps requires Compute optimized
